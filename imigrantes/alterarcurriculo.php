        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="navbarCollapse">
            <ul class="navbar-nav me-auto mb-2 mb-md-0">
              ...
              <li class="nav-item" style="display: block;">
                <a class="nav-link active" href="alterarcurriculo.html" >Alterar currículo</a>
              </li>
            </ul>
    ...
    <div class="container">
      ...
      <div class="row">
        <form class="row g-3" method="POST" action="http://imigrantes.quizall.com.br/alteraimigrantes.php">
          ...
          <div class="col-md-3">
            <label for="inputgenero4" class="form-label">Gênero</label>
          ...
          <div class="col-md-4"  style="display: none;" id="cidadeDivSp">
            ...
            <select class="form-select" id="selectsp" disabled onchange="cidade(this)">
              ...
              <option value="2">São Paulo 2</option>
          ...
          <div class="mb-3">
            <label for="inputdataformacao4" class="form-label">Formação</label>
            <textarea class="form-control" id="inputdataformacao4" rows="3"></textarea>
          </div>
          <div class="mb-3">
            <label for="inputdataexpanteriores4" class="form-label">Experiências anteriores</label>
